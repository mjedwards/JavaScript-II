...
let fullNames = [];
runners.forEach( i => {
  if(i) {return fullNames.push(i.first_name  +  i.last_name);}
})
...
runnersLargeSizeShirt = runners.filter(wo => wo.shirt_size === "L");
// runners.forEach(a => {
//   if(a.shirt_size === "L") {
//     runnersLargeSizeShirt.push(a);
//   }
// })
...
runners.forEach(b => {
  if(b.donation) {
   counter.push(b.donation)
  }
})
ticketPriceTotal = counter.reduce((w, e) => w + e, 0);
